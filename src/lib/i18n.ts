...
const t: Record<string, Record<Lang, string>> = {
  ...
  'ai.stageAnalyzing': { English: 'Analyzing reference documents and extracting context.', Mandarin: '正在分析参考文档并提取上下文。' },
  'ai.stagePlanning': { English: 'Planning the module and lesson sequence.', Mandarin: '正在规划模块和课程顺序。' },
  'ai.stageGeneratingPPTs': { English: 'Generating presentation slides for lessons.', Mandarin: '正在生成课程演示幻灯片。' },
  ...
  'ai.publishing': { English: 'Saving...', Mandarin: '保存中...' },
  'ai.publishModule': { English: 'Save as Draft', Mandarin: '保存为草稿' },
