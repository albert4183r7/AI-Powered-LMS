...
const t: Record<string, Record<Lang, string>> = {
  ...
  'ai.depthLabel': { English: 'Module depth', Mandarin: '模块深度' },
  'ai.depthShort': { English: 'Short', Mandarin: '简短' },
  'ai.depthShortDescription': { English: 'About 3 lessons', Mandarin: '约 3 节课' },
  'ai.depthStandard': { English: 'Standard', Mandarin: '标准' },
  'ai.depthStandardDescription': { English: 'About 5 lessons', Mandarin: '约 5 节课' },
  'ai.depthComprehensive': { English: 'Comprehensive', Mandarin: '全面' },
  'ai.depthComprehensiveDescription': { English: 'About 8 lessons', Mandarin: '约 8 节课' },
